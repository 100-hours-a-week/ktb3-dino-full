...
public class PostService {
    ...
    public PostDto create(String title,Long userid, String author, String content, String imageUrlIgnored){ // image 미사용
        return repo.save(title, userid, author, content);
    }
    ...
    public PostRepository.EditStatus edit(Long postId, Long userId, String newAuthor, String title, String content){
        return repo.edit(postId, userId, newAuthor, title, content);
    }

    public PostRepository.DeleteStatus delete(Long postId, Long userid){
